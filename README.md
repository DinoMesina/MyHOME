...
- **Comprehensive Test Suite**: Over 770 automated unit tests (99% line coverage) executed across modern Python 3.12+ and Home Assistant core standards.
...
- **`test-coverage`**: 772 automated unit tests with snapshot matching and coverage tracking.
...
| [`switch.py`](custom_components/myhome/switch.py) | **98%** | Relay actuators, auxiliary switches, socket controllers |
| [`ownd/message.py`](custom_components/myhome/ownd/message.py) | **98%** | OpenWebNet frame parsers, encoders, and dimension decoders |
